...
export default function ChannelIcon({ channelName, className = "" }) {
  // Determine icon based on channel name
  const getChannelIcon = (name) => {
    const lowerName = name.toLowerCase();

    if (lowerName.includes("general") || lowerName.includes("main")) {
      return (
    ...
    if (lowerName.includes("random") || lowerName.includes("off-topic")) {
      return (
        <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
          <path
            fillRule="evenodd"
    ...
    if (lowerName.includes("announcements") || lowerName.includes("news")) {
      return (
        <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
          <path
            fillRule="evenodd"
    ...
    if (lowerName.includes("help") || lowerName.includes("support")) {
      return (
        <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
          <path
            fillRule="evenodd"
